...
//	OBD_FUEL_TYPE("obd_fuel_type", R.string.obd_fuel_type, R.string.obd_fuel_type_desc, R.drawable.widget_weather_temperature_day, R.drawable.widget_weather_temperature_night, 0, VEHICLE_METRICS, RIGHT),
	...
	NAUTICAL_SOG("nautical_sog", R.string.nautical_sog, R.string.nautical_sog_desc, R.drawable.ic_action_nautical_sog, R.drawable.ic_action_nautical_sog, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_STW("nautical_stw", R.string.nautical_stw, R.string.nautical_stw_desc, R.drawable.ic_action_nautical_stw, R.drawable.ic_action_nautical_stw, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_DEPTH("nautical_depth", R.string.nautical_widget_depth_label, R.string.nautical_depth_desc, R.drawable.ic_action_nautical_depth_transducer, R.drawable.ic_action_nautical_depth_transducer, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_WIND("nautical_wind", R.string.nautical_widget_wind_label, R.string.nautical_wind_desc, R.drawable.ic_action_nautical_wind_true, R.drawable.ic_action_nautical_wind_true, 0, WidgetGroup.NAUTICAL, RIGHT),
	...
	NAUTICAL_VMG("nautical_vmg", R.string.nautical_widget_vmg_label, R.string.nautical_vmg_desc, R.drawable.ic_action_nautical_vmg, R.drawable.ic_action_nautical_vmg, 0, WidgetGroup.NAUTICAL, RIGHT),
	...
	NAUTICAL_HEADING_MAGNETIC("nautical_heading_magnetic", R.string.nautical_heading_magnetic, R.string.nautical_heading_magnetic_desc, R.drawable.ic_action_nautical_heading, R.drawable.ic_action_nautical_heading, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_LOG("nautical_log", R.string.nautical_log, R.string.nautical_log_desc, R.drawable.ic_action_nautical_log, R.drawable.ic_action_nautical_log, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_TRIP_LOG("nautical_trip_log", R.string.nautical_trip_log, R.string.nautical_trip_log_desc, R.drawable.ic_action_nautical_trip, R.drawable.ic_action_nautical_trip, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_ROLL("nautical_roll", R.string.nautical_roll, R.string.nautical_roll_desc, R.drawable.ic_action_nautical_roll, R.drawable.ic_action_nautical_roll, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_PITCH("nautical_pitch", R.string.nautical_pitch, R.string.nautical_pitch_desc, R.drawable.ic_action_nautical_pitch, R.drawable.ic_action_nautical_pitch, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_DEPTH_KEEL("nautical_depth_keel", R.string.nautical_depth_keel, R.string.nautical_depth_keel_desc, R.drawable.ic_action_nautical_depth_keel, R.drawable.ic_action_nautical_depth_keel, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_WATER_TEMP("nautical_water_temp", R.string.nautical_water_temp, R.string.nautical_water_temp_desc, R.drawable.ic_action_nautical_water_temp, R.drawable.ic_action_nautical_water_temp, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_OUTSIDE_TEMP("nautical_outside_temp", R.string.nautical_outside_temp, R.string.nautical_outside_temp_desc, R.drawable.ic_action_nautical_outside_temp, R.drawable.ic_action_nautical_outside_temp, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_PRESSURE("nautical_pressure", R.string.nautical_pressure, R.string.nautical_pressure_desc, R.drawable.widget_weather_air_pressure_day, R.drawable.widget_weather_air_pressure_night, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_ENGINE_RPM("nautical_engine_rpm", R.string.nautical_engine_rpm, R.string.nautical_engine_rpm_desc, R.drawable.ic_action_obd_engine_speed, R.drawable.ic_action_obd_engine_speed, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_ENGINE_TEMP("nautical_engine_temp", R.string.nautical_engine_temp, R.string.nautical_engine_temp_desc, R.drawable.ic_action_nautical_engine_temp, R.drawable.ic_action_nautical_engine_temp, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_BATTERY_VOLT("nautical_battery_volt", R.string.nautical_battery_volt, R.string.nautical_battery_volt_desc, R.drawable.ic_action_nautical_battery_volt, R.drawable.ic_action_nautical_battery_volt, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_BATTERY_SOC("nautical_battery_soc", R.string.nautical_battery_soc, R.string.nautical_battery_soc_desc, R.drawable.ic_action_nautical_battery_soc, R.drawable.ic_action_nautical_battery_soc, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_FUEL_LEVEL("nautical_fuel_level", R.string.nautical_fuel_level, R.string.nautical_fuel_level_desc, R.drawable.ic_action_fuel_tank, R.drawable.ic_action_fuel_tank, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_FRESH_WATER_LEVEL("nautical_fresh_water_level", R.string.nautical_fresh_water_level, R.string.nautical_fresh_water_level_desc, R.drawable.ic_action_nautical_water_tank, R.drawable.ic_action_nautical_water_tank, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_WASTE_WATER_LEVEL("nautical_waste_water_level", R.string.nautical_waste_water_level, R.string.nautical_waste_water_level_desc, R.drawable.ic_action_nautical_waste_tank, R.drawable.ic_action_nautical_waste_tank, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_POLAR_RATIO("nautical_polar_ratio", R.string.nautical_polar_ratio, R.string.nautical_polar_ratio_desc, R.drawable.ic_action_nautical_perf, R.drawable.ic_action_nautical_perf, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_ROT("nautical_rot", R.string.nautical_rot, R.string.nautical_rot_desc, R.drawable.ic_action_nautical_rot, R.drawable.ic_action_nautical_rot, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_XTE("nautical_xte", R.string.nautical_xte, R.string.nautical_xte_desc, R.drawable.ic_action_nautical_xte, R.drawable.ic_action_nautical_xte, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_TTW("nautical_ttw", R.string.nautical_ttw, R.string.nautical_ttw_desc, R.drawable.ic_action_nautical_ttw, R.drawable.ic_action_nautical_ttw, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_DTW("nautical_dtw", R.string.nautical_dtw, R.string.nautical_dtw_desc, R.drawable.ic_action_distance, R.drawable.ic_action_distance, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_ETA("nautical_eta", R.string.nautical_eta, R.string.nautical_eta_desc, R.drawable.ic_action_nautical_eta, R.drawable.ic_action_nautical_eta, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_AWA("nautical_awa", R.string.nautical_awa, R.string.nautical_awa_desc, R.drawable.ic_action_nautical_awa, R.drawable.ic_action_nautical_awa, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_AWS("nautical_aws", R.string.nautical_aws, R.string.nautical_aws_desc, R.drawable.ic_action_nautical_aws, R.drawable.ic_action_nautical_aws, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_TWA("nautical_twa", R.string.nautical_twa, R.string.nautical_twa_desc, R.drawable.ic_action_nautical_twa, R.drawable.ic_action_nautical_twa, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_TWD("nautical_twd", R.string.nautical_twd, R.string.nautical_twd_desc, R.drawable.ic_action_nautical_twd, R.drawable.ic_action_nautical_twd, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_OIL_PRESSURE("nautical_oil_pressure", R.string.nautical_oil_pressure, R.string.nautical_oil_pressure_desc, R.drawable.ic_action_nautical_oil_pressure, R.drawable.ic_action_nautical_oil_pressure, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_ENGINE_LOAD("nautical_engine_load", R.string.nautical_engine_load, R.string.nautical_engine_load_desc, R.drawable.ic_action_nautical_engine_load, R.drawable.ic_action_nautical_engine_load, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_BATTERY_CURRENT("nautical_battery_current", R.string.nautical_battery_current, R.string.nautical_battery_current_desc, R.drawable.ic_action_nautical_battery_current, R.drawable.ic_action_nautical_battery_current, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_SOLAR_CURRENT("nautical_solar_current", R.string.nautical_solar_current, R.string.nautical_solar_current_desc, R.drawable.ic_action_nautical_solar_current, R.drawable.ic_action_nautical_solar_current, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_ENGINE_RUNTIME("nautical_engine_runtime", R.string.nautical_engine_runtime, R.string.nautical_engine_runtime_desc, R.drawable.widget_obd_engine_runtime_day, R.drawable.widget_obd_engine_runtime_night, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_ENGINE_COOLANT("nautical_engine_coolant", R.string.nautical_engine_coolant, R.string.nautical_engine_coolant_desc, R.drawable.ic_action_nautical_engine_coolant, R.drawable.ic_action_nautical_engine_coolant, 0, WidgetGroup.NAUTICAL, RIGHT),
	NAUTICAL_ENGINE_STATE("nautical_engine_state", R.string.nautical_engine_state, R.string.nautical_engine_state_desc, R.drawable.ic_action_nautical_engine_state, R.drawable.ic_action_nautical_engine_state, 0, WidgetGroup.NAUTICAL, RIGHT),
