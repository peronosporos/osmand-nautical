...
//	OBD_FUEL_TYPE("obd_fuel_type", R.string.obd_fuel_type, R.string.obd_fuel_type_desc, R.drawable.widget_weather_temperature_day, R.drawable.widget_weather_temperature_night, 0, VEHICLE_METRICS, RIGHT),
	...
	NAUTICAL_SOG("nautical_sog", R.string.nautical_sog, R.string.nautical_sog_desc, R.drawable.ic_action_nautical_sog, R.drawable.ic_action_nautical_sog, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_STW("nautical_stw", R.string.nautical_stw, R.string.nautical_stw_desc, R.drawable.ic_action_nautical_stw, R.drawable.ic_action_nautical_stw, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_DEPTH("nautical_depth", R.string.nautical_widget_depth_label, R.string.nautical_depth_desc, R.drawable.ic_action_nautical_depth_transducer, R.drawable.ic_action_nautical_depth_transducer, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_WIND("nautical_wind", R.string.nautical_widget_wind_label, R.string.nautical_wind_desc, R.drawable.ic_action_nautical_wind_true, R.drawable.ic_action_nautical_wind_true, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_PILOT("nautical_pilot", R.string.nautical_pilot_title, R.string.nautical_pilot_desc, R.drawable.ic_plugin_nautical_map, R.drawable.ic_plugin_nautical_map, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	MANEUVER_OVERLAY("maneuver_overlay", R.string.maneuver_overlay, 0, 0, 0, 0, null, BOTTOM),
	NAUTICAL_VMG("nautical_vmg", R.string.nautical_widget_vmg_label, R.string.nautical_vmg_desc, R.drawable.ic_action_nautical_vmg, R.drawable.ic_action_nautical_vmg, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_COG("nautical_cog", R.string.nautical_widget_cog_label, R.string.nautical_cog_desc, R.drawable.ic_action_cog, R.drawable.ic_action_cog, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_HEADING_MAGNETIC("nautical_heading_magnetic", R.string.nautical_heading_magnetic, R.string.nautical_heading_magnetic_desc, R.drawable.ic_action_nautical_heading, R.drawable.ic_action_nautical_heading, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_LOG("nautical_log", R.string.nautical_log, R.string.nautical_log_desc, R.drawable.ic_action_nautical_log, R.drawable.ic_action_nautical_log, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_TRIP_LOG("nautical_trip_log", R.string.nautical_trip_log, R.string.nautical_trip_log_desc, R.drawable.ic_action_nautical_trip, R.drawable.ic_action_nautical_trip, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_ROLL("nautical_roll", R.string.nautical_roll, R.string.nautical_roll_desc, R.drawable.ic_action_nautical_roll, R.drawable.ic_action_nautical_roll, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_PITCH("nautical_pitch", R.string.nautical_pitch, R.string.nautical_pitch_desc, R.drawable.ic_action_nautical_pitch, R.drawable.ic_action_nautical_pitch, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_DEPTH_KEEL("nautical_depth_keel", R.string.nautical_depth_keel, R.string.nautical_depth_keel_desc, R.drawable.ic_action_nautical_depth_keel, R.drawable.ic_action_nautical_depth_keel, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_WATER_TEMP("nautical_water_temp", R.string.nautical_water_temp, R.string.nautical_water_temp_desc, R.drawable.ic_action_nautical_water_temp, R.drawable.ic_action_nautical_water_temp, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_OUTSIDE_TEMP("nautical_outside_temp", R.string.nautical_outside_temp, R.string.nautical_outside_temp_desc, R.drawable.ic_action_nautical_outside_temp, R.drawable.ic_action_nautical_outside_temp, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_PRESSURE("nautical_pressure", R.string.nautical_pressure, R.string.nautical_pressure_desc, R.drawable.widget_weather_air_pressure_day, R.drawable.widget_weather_air_pressure_night, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_ENGINE_RPM("nautical_engine_rpm", R.string.nautical_engine_rpm, R.string.nautical_engine_rpm_desc, R.drawable.ic_action_obd_engine_speed, R.drawable.ic_action_obd_engine_speed, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_ENGINE_TEMP("nautical_engine_temp", R.string.nautical_engine_temp, R.string.nautical_engine_temp_desc, R.drawable.ic_action_nautical_engine_temp, R.drawable.ic_action_nautical_engine_temp, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_BATTERY_VOLT("nautical_battery_volt", R.string.nautical_battery_volt, R.string.nautical_battery_volt_desc, R.drawable.ic_action_nautical_battery_volt, R.drawable.ic_action_nautical_battery_volt, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_BATTERY_SOC("nautical_battery_soc", R.string.nautical_battery_soc, R.string.nautical_battery_soc_desc, R.drawable.ic_action_nautical_battery_soc, R.drawable.ic_action_nautical_battery_soc, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_FUEL_LEVEL("nautical_fuel_level", R.string.nautical_fuel_level, R.string.nautical_fuel_level_desc, R.drawable.ic_action_fuel_tank, R.drawable.ic_action_fuel_tank, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_FRESH_WATER_LEVEL("nautical_fresh_water_level", R.string.nautical_fresh_water_level, R.string.nautical_fresh_water_level_desc, R.drawable.ic_action_nautical_water_tank, R.drawable.ic_action_nautical_water_tank, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_WASTE_WATER_LEVEL("nautical_waste_water_level", R.string.nautical_waste_water_level, R.string.nautical_waste_water_level_desc, R.drawable.ic_action_nautical_waste_tank, R.drawable.ic_action_nautical_waste_tank, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_POLAR_RATIO("nautical_polar_ratio", R.string.nautical_polar_ratio, R.string.nautical_polar_ratio_desc, R.drawable.ic_action_nautical_perf, R.drawable.ic_action_nautical_perf, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_ROT("nautical_rot", R.string.nautical_rot, R.string.nautical_rot_desc, R.drawable.ic_action_nautical_rot, R.drawable.ic_action_nautical_rot, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_XTE("nautical_xte", R.string.nautical_xte, R.string.nautical_xte_desc, R.drawable.ic_action_nautical_xte, R.drawable.ic_action_nautical_xte, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_TTW("nautical_ttw", R.string.nautical_ttw, R.string.nautical_ttw_desc, R.drawable.ic_action_nautical_ttw, R.drawable.ic_action_nautical_ttw, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_DTW("nautical_dtw", R.string.nautical_dtw, R.string.nautical_dtw_desc, R.drawable.ic_action_distance, R.drawable.ic_action_distance, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_ETA("nautical_eta", R.string.nautical_eta, R.string.nautical_eta_desc, R.drawable.ic_action_nautical_eta, R.drawable.ic_action_nautical_eta, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_AWA("nautical_awa", R.string.nautical_awa, R.string.nautical_awa_desc, R.drawable.ic_action_nautical_awa, R.drawable.ic_action_nautical_awa, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_AWS("nautical_aws", R.string.nautical_aws, R.string.nautical_aws_desc, R.drawable.ic_action_nautical_aws, R.drawable.ic_action_nautical_aws, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_TWA("nautical_twa", R.string.nautical_twa, R.string.nautical_twa_desc, R.drawable.ic_action_nautical_twa, R.drawable.ic_action_nautical_twa, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_TWD("nautical_twd", R.string.nautical_twd, R.string.nautical_twd_desc, R.drawable.ic_action_nautical_twd, R.drawable.ic_action_nautical_twd, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_OIL_PRESSURE("nautical_oil_pressure", R.string.nautical_oil_pressure, R.string.nautical_oil_pressure_desc, R.drawable.ic_action_nautical_oil_pressure, R.drawable.ic_action_nautical_oil_pressure, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_ENGINE_LOAD("nautical_engine_load", R.string.nautical_engine_load, R.string.nautical_engine_load_desc, R.drawable.ic_action_nautical_engine_load, R.drawable.ic_action_nautical_engine_load, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_BATTERY_CURRENT("nautical_battery_current", R.string.nautical_battery_current, R.string.nautical_battery_current_desc, R.drawable.ic_action_nautical_battery_current, R.drawable.ic_action_nautical_battery_current, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_SOLAR_CURRENT("nautical_solar_current", R.string.nautical_solar_current, R.string.nautical_solar_current_desc, R.drawable.ic_action_nautical_solar_current, R.drawable.ic_action_nautical_solar_current, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_ENGINE_RUNTIME("nautical_engine_runtime", R.string.nautical_engine_runtime, R.string.nautical_engine_runtime_desc, R.drawable.widget_obd_engine_runtime_day, R.drawable.widget_obd_engine_runtime_night, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_ENGINE_COOLANT("nautical_engine_coolant", R.string.nautical_engine_coolant, R.string.nautical_engine_coolant_desc, R.drawable.ic_action_nautical_engine_coolant, R.drawable.ic_action_nautical_engine_coolant, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_ENGINE_STATE("nautical_engine_state", R.string.nautical_engine_state, R.string.nautical_engine_state_desc, R.drawable.ic_action_nautical_engine_state, R.drawable.ic_action_nautical_engine_state, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_SET_DRIFT("nautical_set_drift_widget", R.string.nautical_set_drift, R.string.nautical_set_drift, R.drawable.ic_action_nautical_set_drift, R.drawable.ic_action_nautical_set_drift, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_NIGHT_VISION("nautical_night_vision", R.string.nautical_night_vision, R.string.nautical_night_vision_desc, R.drawable.ic_action_red_filter_overlay_on, R.drawable.ic_action_red_filter_off, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_MOB("nautical_mob", R.string.nautical_mob_label, R.string.nautical_mob_desc, R.drawable.ic_action_alert, R.drawable.ic_action_alert, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_MAG_VARIATION("nautical_mag_variation", R.string.nautical_mag_variation, R.string.nautical_mag_variation_desc, R.drawable.ic_action_nautical_heading, R.drawable.ic_action_nautical_heading, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_YAW("nautical_yaw", R.string.nautical_yaw, R.string.nautical_yaw_desc, R.drawable.ic_action_nautical_rot, R.drawable.ic_action_nautical_rot, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_CPA("nautical_cpa", R.string.nautical_cpa, R.string.nautical_cpa_desc, R.drawable.ic_action_alert, R.drawable.ic_action_alert, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_TCPA("nautical_tcpa", R.string.nautical_tcpa, R.string.nautical_tcpa_desc, R.drawable.ic_action_time, R.drawable.ic_action_time, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_RUDDER_ANGLE_TEXT("nautical_rudder_angle_text", R.string.nautical_rudder_angle, R.string.nautical_rudder_angle, R.drawable.ic_action_nautical_rot, R.drawable.ic_action_nautical_rot, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_POLAR_TARGET_SPEED("nautical_polar_target", R.string.nautical_polar_target, R.string.nautical_polar_target, R.drawable.ic_action_nautical_perf, R.drawable.ic_action_nautical_perf, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_RANGE("nautical_range", R.string.nautical_range_empty, R.string.nautical_range_empty, R.drawable.ic_action_distance, R.drawable.ic_action_distance, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_ACTUATOR("nautical_actuator", R.string.nautical_actuator_load, R.string.nautical_actuator_load, R.drawable.ic_action_settings, R.drawable.ic_action_settings, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_COMPASS("nautical_compass_widget", R.string.map_widget_compass, R.string.compass_desc, R.drawable.ic_action_direction_compass, R.drawable.ic_action_direction_compass, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_HUMIDITY("nautical_humidity", R.string.nautical_humidity, R.string.nautical_humidity_desc, R.drawable.ic_action_nautical_outside_temp, R.drawable.ic_action_nautical_outside_temp, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_MOON_PHASE("nautical_moon_phase", R.string.nautical_moon_phase, R.string.nautical_moon_phase_desc, R.drawable.ic_action_moon, R.drawable.ic_action_moon, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_SUNLIGHT_MODE("nautical_sunlight_mode", R.string.nautical_sunlight_mode, R.string.nautical_sunlight_mode_desc, R.drawable.ic_action_sun, R.drawable.ic_action_sun, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_AC_VOLTAGE("nautical_ac_voltage", R.string.nautical_ac_voltage, R.string.nautical_ac_voltage_desc, R.drawable.ic_action_nautical_battery_volt, R.drawable.ic_action_nautical_battery_volt, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_AC_CURRENT("nautical_ac_current", R.string.nautical_ac_current, R.string.nautical_ac_current_desc, R.drawable.ic_action_nautical_battery_current, R.drawable.ic_action_nautical_battery_current, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_AC_FREQUENCY("nautical_ac_frequency", R.string.nautical_ac_frequency, R.string.nautical_ac_frequency_desc, R.drawable.ic_action_settings, R.drawable.ic_action_settings, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_VHF("nautical_vhf", R.string.nautical_vhf_widget_label, R.string.nautical_vhf_widget_label, R.drawable.ic_action_antenna, R.drawable.ic_action_antenna, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_VHF_CHANNEL("nautical_vhf_channel", R.string.nautical_vhf_channel, R.string.nautical_vhf_channel_desc, R.drawable.ic_action_antenna, R.drawable.ic_action_antenna, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_GNSS_QUALITY("nautical_gnss_quality", R.string.nautical_gnss_quality, R.string.nautical_gnss_quality_desc, R.drawable.ic_action_device_location, R.drawable.ic_action_device_location, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_SALINITY("nautical_salinity", R.string.nautical_salinity, R.string.nautical_salinity_desc, R.drawable.ic_action_nautical_water_temp, R.drawable.ic_action_nautical_water_temp, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_DEW_POINT("nautical_dew_point", R.string.nautical_dew_point, R.string.nautical_dew_point_desc, R.drawable.ic_action_nautical_water_temp, R.drawable.ic_action_nautical_water_temp, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_ILLUMINANCE("nautical_illuminance", R.string.nautical_illuminance, R.string.nautical_illuminance_desc, R.drawable.ic_action_sun, R.drawable.ic_action_sun, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_ELECTRICAL("nautical_electrical", R.string.nautical_switches_label, R.string.nautical_switches_label, R.drawable.ic_action_nautical_battery_volt, R.drawable.ic_action_nautical_battery_volt, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_RIGGING_LOAD("nautical_rigging_load", R.string.nautical_rigging_load_label, R.string.nautical_rigging_load_desc, R.drawable.ic_action_settings, R.drawable.ic_action_settings, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_MASTER_TELEMETRY("nautical_master_telemetry", R.string.nautical_master_telemetry, R.string.nautical_master_telemetry_desc, R.drawable.ic_action_nautical_perf, R.drawable.ic_action_nautical_perf, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_CAMERA("nautical_camera", R.string.nautical_camera, R.string.nautical_camera, R.drawable.ic_action_video_dark, R.drawable.ic_action_video_dark, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_MEDIA("nautical_media", R.string.nautical_media_title, R.string.nautical_media_desc, R.drawable.ic_action_play_dark, R.drawable.ic_action_play_dark, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_RACING_TIMER("nautical_racing_timer", R.string.nautical_racing_timer_title, R.string.nautical_racing_timer_desc, R.drawable.ic_action_time, R.drawable.ic_action_time, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_WIND_SHIFT_WIDGET("nautical_wind_shift_widget", R.string.nautical_wind_shift_title, R.string.nautical_wind_shift_desc, R.drawable.ic_action_wind, R.drawable.ic_action_wind, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_WATERMAKER("nautical_watermaker", R.string.nautical_watermaker_title, R.string.nautical_watermaker_desc, R.drawable.ic_action_nautical_water_tank, R.drawable.ic_action_nautical_water_tank, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_TELLTALE("nautical_telltale", R.string.nautical_telltale_title, R.string.nautical_telltale_desc, R.drawable.ic_action_wind, R.drawable.ic_action_wind, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_FLAGS("nautical_flags", R.string.nautical_flags_title, R.string.nautical_flags_desc, R.drawable.ic_action_flag, R.drawable.ic_action_flag, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	NAUTICAL_BOOST_PRESSURE("nautical_boost_pressure", R.string.nautical_boost_pressure, R.string.nautical_boost_pressure, R.drawable.ic_action_nautical_oil_pressure, R.drawable.ic_action_nautical_oil_pressure, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_EXHAUST_TEMP("nautical_exhaust_temp", R.string.nautical_exhaust_temp, R.string.nautical_exhaust_temp, R.drawable.ic_action_nautical_engine_temp, R.drawable.ic_action_nautical_engine_temp, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_ALTERNATOR_VOLT("nautical_alternator_volt", R.string.nautical_alternator_voltage, R.string.nautical_alternator_voltage, R.drawable.ic_action_nautical_battery_volt, R.drawable.ic_action_nautical_battery_volt, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_ALTERNATOR_CURR("nautical_alternator_curr", R.string.nautical_alternator_current, R.string.nautical_alternator_current, R.drawable.ic_action_nautical_battery_current, R.drawable.ic_action_nautical_battery_current, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_TRANS_GEAR("nautical_trans_gear", R.string.nautical_transmission_gear, R.string.nautical_transmission_gear, R.drawable.ic_action_settings, R.drawable.ic_action_settings, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_TRANS_PRESS("nautical_trans_press", R.string.nautical_transmission_pressure, R.string.nautical_transmission_pressure, R.drawable.ic_action_nautical_oil_pressure, R.drawable.ic_action_nautical_oil_pressure, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_TRANS_OIL_TEMP("nautical_trans_oil_temp", R.string.nautical_transmission_oil_temp, R.string.nautical_transmission_oil_temp, R.drawable.ic_action_nautical_engine_temp, R.drawable.ic_action_nautical_engine_temp, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_INV_STATE("nautical_inv_state", R.string.nautical_inverter_state, R.string.nautical_inverter_state, R.drawable.ic_action_nautical_battery_volt, R.drawable.ic_action_nautical_battery_volt, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_CHG_STATE("nautical_chg_state", R.string.nautical_charger_state, R.string.nautical_charger_state, R.drawable.ic_action_nautical_battery_volt, R.drawable.ic_action_nautical_battery_volt, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_WATERMAKER_RATE("nautical_watermaker_rate", R.string.nautical_watermaker_rate, R.string.nautical_watermaker_rate, R.drawable.ic_action_nautical_water_tank, R.drawable.ic_action_nautical_water_tank, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
