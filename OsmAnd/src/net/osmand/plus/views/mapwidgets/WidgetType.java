...
//	OBD_FUEL_TYPE("obd_fuel_type", R.string.obd_fuel_type, R.string.obd_fuel_type_desc, R.drawable.widget_weather_temperature_day, R.drawable.widget_weather_temperature_night, 0, VEHICLE_METRICS, RIGHT),
	...
	NAUTICAL_RANGE("nautical_range", R.string.nautical_range_empty, R.string.nautical_range_empty, R.drawable.ic_action_settings, R.drawable.ic_action_settings, 0, WidgetGroup.NAUTICAL_TELEMETRY, RIGHT),
	...
	NAUTICAL_VHF_CHANNEL("nautical_vhf_channel", R.string.nautical_vhf_channel, R.string.nautical_vhf_channel_desc, R.drawable.ic_action_settings, R.drawable.ic_action_settings, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	...
	NAUTICAL_BOOST_PRESSURE("nautical_boost_pressure", R.string.nautical_boost_pressure, R.string.nautical_boost_pressure, R.drawable.ic_action_settings, R.drawable.ic_action_settings, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	...
	NAUTICAL_TRANS_PRESS("nautical_trans_press", R.string.nautical_transmission_pressure, R.string.nautical_transmission_pressure, R.drawable.ic_action_settings, R.drawable.ic_action_settings, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	...
	NAUTICAL_INV_STATE("nautical_inv_state", R.string.nautical_inverter_state, R.string.nautical_inverter_state, R.drawable.ic_action_settings, R.drawable.ic_action_settings, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
	NAUTICAL_CHG_STATE("nautical_chg_state", R.string.nautical_charger_state, R.string.nautical_charger_state, R.drawable.ic_action_settings, R.drawable.ic_action_settings, 0, WidgetGroup.NAUTICAL_SYSTEMS, RIGHT),
