...
class NauticalSettingsFragment : BaseSettingsFragment() {
    ...
    private fun setupXteThreshold() {
        findPreference<EditTextPreferenceEx>("nautical_xte_threshold")?.apply {
            ...
            summary = "${settings.NAUTICAL_XTE_THRESHOLD.get()} NM"
        }
    }
    ...
    override fun onPreferenceChange(preference: Preference, newValue: Any?): Boolean {
        ...
        if (changed) {
            ...
            when (key) {
                ...
                "server_password" -> preference.summary = if (newString.isEmpty()) getString(R.string.nautical_server_password_desc) else "********"
                ...
                "nautical_xte_threshold" -> {
                    ...
                    preference.summary = "$floatValue NM"
                }
            }
        }
        return changed
